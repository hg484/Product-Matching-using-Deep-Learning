...
pretrained_model=ResNet101(weights='imagenet',include_top=False,input_shape=[HEIGHT,WIDTH, 3])
model_training(pretrained_model,resnet101_model_path)
...
# pretrained_model=EfficientNetB5(include_top=False, weights='imagenet',pooling='avg',input_shape=[HEIGHT,WIDTH, 3])
# model_training(pretrained_model,efnb5_model_path)