...
app.config["IMAGE_UPLOADS"] = os.getcwd()+"/app/static/img/upload_images/"
...
IMAGE_EMBEDDINGS_PATH="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/model and embeddings/"
TEXT_EMBEDDINGS_PATH="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/model and embeddings/"
...
train=pd.read_csv("/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/model and embeddings/train.csv")
...
def index():
    ...
    if request.method=="POST":
        ...
        if request.form["text"]:
            ...
            image_path="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/static/img/demo_images/demo_image_3.jpg"

        elif request.form.get("demo_2_button"):
            print(2)
            text="SENKA Perfect Whip Facial Foam (Shiseido)"
            image_path="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/static/img/demo_images/demo_image_perfect_whip.jpg"

        elif request.form.get("demo_3_button"):
            print(3)
            text="RATU MAYCREATE MOISTURIZING SPRAY - LOTION SPRAY MAY CREATE 150ML ORIGINAL"
            image_path="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/static/img/demo_images/demo_image_lotion_spray.jpg"

        elif request.form.get("demo_4_button"):
            print(4)
            text="Headset / Handsfree U19 macaron / Macaroon Mate Color Hifi Extra Bass"
            image_path="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/static/img/demo_images/demo_image_2.jpg"

        elif request.form.get("demo_5_button"):
            print(5)
            text="Emina Glossy Stain 01 Autumn Bell"
            image_path="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/static/img/demo_images/demo_image_1.jpg"
        
        elif  request.form.get("demo_6_button"):
            print("Random Input 1")
            text="Player wearing a hoodie"
            image_path="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/static/img/demo_images/basketball player.jpg"

        elif  request.form.get("demo_7_button"):
            print("Random Input 2")
            text="Prime minster of Japan wearing a Suit"
            image_path="/home/harsh_gupta/Downloads/Git_Repos/product_matching_web_app/app/app/static/img/demo_images/abe sad.jpg"
